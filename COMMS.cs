...
namespace LukMachine
{
  public sealed class COMMS
  {
    ...
    public static void calculateVoltageReferences()
    {
      ...
      //this section is not needed, if it is needed then the com bridge is probably broken!
      /*if (Ref0V == 0)
      {
        Ref0V = 2000;
        Properties.Settings.Default.ground = Ref0V;
      }
      if (Ref2V == 0)
      {
        Ref2V = 14000;
        Properties.Settings.Default.RefCount2V = Ref2V;
      }*/
