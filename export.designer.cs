namespace LukMachine
{
    partial class export
    {
      ...
      // pictureBox1
      // 
      this.pictureBox1.Image = global::LukMachine.Properties.Resources._1446234604_application_vnd_ms_excel;
      ...
      this.button3.Location = new System.Drawing.Point(345, 159);
      ...
      this.radioButton3.Location = new System.Drawing.Point(25, 99);
      this.radioButton3.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
      this.radioButton3.Name = "radioButton3";
      this.radioButton3.Size = new System.Drawing.Size(287, 27);
      this.radioButton3.TabIndex = 3;
      this.radioButton3.TabStop = true;
      this.radioButton3.Text = "Export comparative analysis ";
      this.toolTip1.SetToolTip(this.radioButton3, "Exports Excel sheet showing multiple tests");
      ...
      this.radioButton2.Size = new System.Drawing.Size(162, 27);
      this.radioButton2.TabIndex = 2;
      this.radioButton2.TabStop = true;
      this.radioButton2.Text = "Export all data\r\n";
      this.toolTip1.SetToolTip(this.radioButton2, "Exports each loaded data file to their own respective excel file.");
      ...
      this.radioButton1.Size = new System.Drawing.Size(226, 27);
      this.radioButton1.TabIndex = 1;
      this.radioButton1.TabStop = true;
      this.radioButton1.Text = "Export single data set";
      this.toolTip1.SetToolTip(this.radioButton1, "xport only one single data file.");
      this.radioButton1.UseVisualStyleBackColor = true;
      this.radioButton1.Visible = false;
      // 
      // folderBrowserDialog1
      // 
      this.folderBrowserDialog1.Description = "Select a location to export your selected data to";
      // 
      // export
      // 
